...
Generated locally at 2026-09-16T14:03:11.336203-04:00.
...
For class I, a red sequence slash or ligand-window tick requires all four displayed intracellular tracks to assess the bond and at least three to reach the 0.5 display threshold; the adjacent 3/4 or 4/4 label is a support fraction, not a probability. Red ticks inside a ligand bar are pre-binding internal cleavage evidence in the relevant processing view. They do not establish that a bound pMHC complex will be cleaved or protected; binding occupancy and timing are not modeled.
